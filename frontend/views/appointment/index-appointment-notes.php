...
$this->title = 'Action Notes';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="appointment-notes-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
             ...
             'template' => '{appointment-note} {update-appointment-note}',
             'buttons' => [
                'appointment-note' => function ($url) {
                    return Html::a(
                ...
                'update-appointment-note' => function ($url) {
                    return Html::a(
