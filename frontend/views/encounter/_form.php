...
<div class="encounter-form">
    ...
    <?= $form->field($model, 'patientlocation')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'patientlocationid')->dropdownList($patientLocations,
        ['prompt'=>'Select a Patient Location']
    );?>

    <?= $form->field($model, 'patientstatus')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'patientstatusid')->dropdownList($patientStatuses,
        ['prompt'=>'Select a Patient Status']
    );?>

    <?= $form->field($model, 'providerfirstname')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'providerid')->textInput() ?>

    <?= $form->field($model, 'providerlastname')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'providerphone')->textInput(['maxlength' => true]) ?>
