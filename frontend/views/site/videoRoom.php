...
/* @var $this View */
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/webrtc-adapter/8.0.0/adapter.min.js');
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/jquery.blockUI/2.70/jquery.blockUI.min.js', ['depends' => yii\web\JqueryAsset::class]);
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.min.js', ['depends' => yii\web\JqueryAsset::class]);
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/spin.js/2.3.2/spin.min.js', ['depends' => yii\web\JqueryAsset::class]);
$this->registerJsFile('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.4/toastr.min.js', ['depends' => yii\web\JqueryAsset::class]);
$this->registerJsFile('/js/janus.js', ['depends' => yii\web\JqueryAsset::class]);
$this->registerJsFile('/js/videoroomtest.js', ['depends' => yii\web\JqueryAsset::class]);
?>
