 ...
 */
class m220121_000000_004_sleep_summary_object_data extends \yii\db\Migration
{
    public function up()
    {
        $this->createTable('{{%wth_sleep_summary_object_datas}}', [
    ...
    {
        $this->dropTable('{{%wth_sleep_summary_object_datas}}');
    }
}
