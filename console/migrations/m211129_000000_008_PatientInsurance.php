...
/**
 * Table for PatientInsurance
 */
class m211129_000000_008_PatientInsurance extends \yii\db\Migration
{
    public function up()
    {
        $this->createTable('{{%patient_insurances}}', [
    ...
    {
        $this->dropTable('{{%patient_insurances}}');
    }
}
