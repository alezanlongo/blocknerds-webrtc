...
class AthenaClient extends \common\components\Athena\AthenaOauth
{
    ...
    public function getPracticeidAppointmentsOpen($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['appointments'])) ? $dataResponse['data']['appointments'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\AppointmentSlotResponseApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidPatientsPatientidDocumentsLabresult($practiceid, $patientid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['labresult'])) ? $dataResponse['data']['labresult'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\LabResultApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function postPracticeidPatientsPatientidDocumentsLabresult($practiceid, $patientid, array $body = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'post' , $body);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResult200ResponseApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    public function getPracticeidPatientsPatientidDocumentsLabresultLabresultid($practiceid, $patientid, $labresultid, array $query = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'get' , $query);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResultApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
     ...
     * @param practiceid
     * @param documentid
     * @return LabResultSuccessProcess
     */
    public function putPracticeidDocumentsLabresultDocumentidDataentrycompleted($practiceid, $documentid, array $body = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'put' , $body);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResultSuccessProcessApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    /**
     * @param practiceid
     * @return LabResultSuscriptionEvent
     */
    public function getPracticeidLabresultsChangedSubscriptionEvents($practiceid, array $query = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'get' , $query);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResultSuscriptionEventApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    /**
     * @param practiceid
     * @return LabResultSuscriptionSuccess
     */
    public function postPracticeidLabresultsChangedSubscription($practiceid, array $body = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'post' , $body);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResultSuscriptionSuccessApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    public function getPracticeidLabresultsChanged($practiceid, array $query = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'get' , $query);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\LabResultChangedApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    public function getPracticeidChartEncounterEncounteridOrdersOrderid($practiceid, $encounterid, $orderid, array $query = [])
    {
        ...
        $dataResponse = $this->callMethod($path, 'get' , $query);
        if($dataResponse['success']){
            return new \common\components\Athena\apiModels\OrderApi($dataResponse['data']);
        }else{
            return $dataResponse['message'];
        }
    }
    ...
    public function getPracticeidReferenceOrderPrescriptionDosagequantityunits($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['dosagequantityunits'])) ? $dataResponse['data']['dosagequantityunits'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\DosageQuantityUnitApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderPrescriptionFrequencies($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['frequencies'])) ? $dataResponse['data']['frequencies'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\FrequencyApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderPrescription($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['prescription'])) ? $dataResponse['data']['prescription'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\OrderableMedicationApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderPrescriptionTotalquantityunits($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['totalquantityunits'])) ? $dataResponse['data']['totalquantityunits'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\TotalQuantityUnitApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderImaging($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['imaging'])) ? $dataResponse['data']['imaging'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\OrderableImagingApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderDme($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['dme'])) ? $dataResponse['data']['dme'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\OrderableDmeApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderVaccine($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['vaccine'])) ? $dataResponse['data']['vaccine'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\OrderableVaccineApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderPatientinfo($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['patientinfo'])) ? $dataResponse['data']['patientinfo'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\PatientInfoHandoutApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderReferral($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['referral'])) ? $dataResponse['data']['referral'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\ReferralOrderTypeApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
    ...
    public function getPracticeidReferenceOrderOther($practiceid, array $query = [])
    {
        ...
        if($dataResponse['success']){
            $dataApiModel = [];
            $responseData = (isset($dataResponse['data']['other'])) ? $dataResponse['data']['other'] : $dataResponse['data'];
            foreach ($responseData as $key => $value){
                array_push($dataApiModel, new  \common\components\Athena\apiModels\OtherOrderTypeApi($value));
            }
            return $dataApiModel;
        }else{
            return $dataResponse['message'];
