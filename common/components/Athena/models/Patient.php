...
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function loadApiObject($apiObject) {
        ...
        $this->address1 = ArrayHelper::getValue($obj, 'address1');
        $this->address2 = ArrayHelper::getValue($obj, 'address2');
        $this->agriculturalworker = ArrayHelper::getValue($obj, 'agriculturalworker');
        $this->agriculturalworkertype = ArrayHelper::getValue($obj, 'agriculturalworkertype');
        $this->balances = ArrayHelper::getValue($obj, 'balances');
        $this->caresummarydeliverypreference = ArrayHelper::getValue($obj, 'caresummarydeliverypreference');
        $this->city = ArrayHelper::getValue($obj, 'city');
        $this->claimbalancedetails = ArrayHelper::getValue($obj, 'claimbalancedetails');
        $this->confidentialitycode = ArrayHelper::getValue($obj, 'confidentialitycode');
        $this->consenttocall = ArrayHelper::getValue($obj, 'consenttocall');
        $this->consenttotext = ArrayHelper::getValue($obj, 'consenttotext');
        $this->contacthomephone = ArrayHelper::getValue($obj, 'contacthomephone');
        $this->contactmobilephone = ArrayHelper::getValue($obj, 'contactmobilephone');
        $this->contactname = ArrayHelper::getValue($obj, 'contactname');
        $this->contactpreference = ArrayHelper::getValue($obj, 'contactpreference');
        $this->contactpreference_announcement_email = ArrayHelper::getValue($obj, 'contactpreference_announcement_email');
        $this->contactpreference_announcement_phone = ArrayHelper::getValue($obj, 'contactpreference_announcement_phone');
        $this->contactpreference_announcement_sms = ArrayHelper::getValue($obj, 'contactpreference_announcement_sms');
        $this->contactpreference_appointment_email = ArrayHelper::getValue($obj, 'contactpreference_appointment_email');
        $this->contactpreference_appointment_phone = ArrayHelper::getValue($obj, 'contactpreference_appointment_phone');
        $this->contactpreference_appointment_sms = ArrayHelper::getValue($obj, 'contactpreference_appointment_sms');
        $this->contactpreference_billing_email = ArrayHelper::getValue($obj, 'contactpreference_billing_email');
        $this->contactpreference_billing_phone = ArrayHelper::getValue($obj, 'contactpreference_billing_phone');
        $this->contactpreference_billing_sms = ArrayHelper::getValue($obj, 'contactpreference_billing_sms');
        $this->contactpreference_lab_email = ArrayHelper::getValue($obj, 'contactpreference_lab_email');
        $this->contactpreference_lab_phone = ArrayHelper::getValue($obj, 'contactpreference_lab_phone');
        $this->contactpreference_lab_sms = ArrayHelper::getValue($obj, 'contactpreference_lab_sms');
        $this->contactrelationship = ArrayHelper::getValue($obj, 'contactrelationship');
        $this->countrycode = ArrayHelper::getValue($obj, 'countrycode');
        $this->countrycode3166 = ArrayHelper::getValue($obj, 'countrycode3166');
        $this->customfields = ArrayHelper::getValue($obj, 'customfields');
        $this->deceaseddate = ArrayHelper::getValue($obj, 'deceaseddate');
        $this->defaultpharmacyncpdpid = ArrayHelper::getValue($obj, 'defaultpharmacyncpdpid');
        $this->departmentid = ArrayHelper::getValue($obj, 'departmentid');
        $this->dob = ArrayHelper::getValue($obj, 'dob');
        $this->donotcallyn = ArrayHelper::getValue($obj, 'donotcallyn');
        $this->driverslicenseexpirationdate = ArrayHelper::getValue($obj, 'driverslicenseexpirationdate');
        $this->driverslicensenumber = ArrayHelper::getValue($obj, 'driverslicensenumber');
        $this->driverslicensestateid = ArrayHelper::getValue($obj, 'driverslicensestateid');
        $this->driverslicenseurl = ArrayHelper::getValue($obj, 'driverslicenseurl');
        $this->driverslicenseyn = ArrayHelper::getValue($obj, 'driverslicenseyn');
        $this->email = ArrayHelper::getValue($obj, 'email');
        $this->emailexistsyn = ArrayHelper::getValue($obj, 'emailexistsyn');
        $this->employeraddress = ArrayHelper::getValue($obj, 'employeraddress');
        $this->employercity = ArrayHelper::getValue($obj, 'employercity');
        $this->employerfax = ArrayHelper::getValue($obj, 'employerfax');
        $this->employerid = ArrayHelper::getValue($obj, 'employerid');
        $this->employername = ArrayHelper::getValue($obj, 'employername');
        $this->employerphone = ArrayHelper::getValue($obj, 'employerphone');
        $this->employerstate = ArrayHelper::getValue($obj, 'employerstate');
        $this->employerzip = ArrayHelper::getValue($obj, 'employerzip');
        $this->ethnicitycode = ArrayHelper::getValue($obj, 'ethnicitycode');
        $this->firstappointment = ArrayHelper::getValue($obj, 'firstappointment');
        $this->firstname = ArrayHelper::getValue($obj, 'firstname');
        $this->guarantoraddress1 = ArrayHelper::getValue($obj, 'guarantoraddress1');
        $this->guarantoraddress2 = ArrayHelper::getValue($obj, 'guarantoraddress2');
        $this->guarantoraddresssameaspatient = ArrayHelper::getValue($obj, 'guarantoraddresssameaspatient');
        $this->guarantorcity = ArrayHelper::getValue($obj, 'guarantorcity');
        $this->guarantorcountrycode = ArrayHelper::getValue($obj, 'guarantorcountrycode');
        $this->guarantorcountrycode3166 = ArrayHelper::getValue($obj, 'guarantorcountrycode3166');
        $this->guarantordob = ArrayHelper::getValue($obj, 'guarantordob');
        $this->guarantoremail = ArrayHelper::getValue($obj, 'guarantoremail');
        $this->guarantoremployerid = ArrayHelper::getValue($obj, 'guarantoremployerid');
        $this->guarantorfirstname = ArrayHelper::getValue($obj, 'guarantorfirstname');
        $this->guarantorlastname = ArrayHelper::getValue($obj, 'guarantorlastname');
        $this->guarantormiddlename = ArrayHelper::getValue($obj, 'guarantormiddlename');
        $this->guarantorphone = ArrayHelper::getValue($obj, 'guarantorphone');
        $this->guarantorrelationshiptopatient = ArrayHelper::getValue($obj, 'guarantorrelationshiptopatient');
        $this->guarantorssn = ArrayHelper::getValue($obj, 'guarantorssn');
        $this->guarantorstate = ArrayHelper::getValue($obj, 'guarantorstate');
        $this->guarantorsuffix = ArrayHelper::getValue($obj, 'guarantorsuffix');
        $this->guarantorzip = ArrayHelper::getValue($obj, 'guarantorzip');
        $this->guardianfirstname = ArrayHelper::getValue($obj, 'guardianfirstname');
        $this->guardianlastname = ArrayHelper::getValue($obj, 'guardianlastname');
        $this->guardianmiddlename = ArrayHelper::getValue($obj, 'guardianmiddlename');
        $this->guardiansuffix = ArrayHelper::getValue($obj, 'guardiansuffix');
        $this->hasmobileyn = ArrayHelper::getValue($obj, 'hasmobileyn');
        $this->hierarchicalcode = ArrayHelper::getValue($obj, 'hierarchicalcode');
        $this->homeboundyn = ArrayHelper::getValue($obj, 'homeboundyn');
        $this->homeless = ArrayHelper::getValue($obj, 'homeless');
        $this->homelesstype = ArrayHelper::getValue($obj, 'homelesstype');
        $this->homephone = ArrayHelper::getValue($obj, 'homephone');
        $this->industrycode = ArrayHelper::getValue($obj, 'industrycode');
        $this->insurances = ArrayHelper::getValue($obj, 'insurances');
        $this->language6392code = ArrayHelper::getValue($obj, 'language6392code');
        $this->lastappointment = ArrayHelper::getValue($obj, 'lastappointment');
        $this->lastemail = ArrayHelper::getValue($obj, 'lastemail');
        $this->lastname = ArrayHelper::getValue($obj, 'lastname');
        $this->maritalstatus = ArrayHelper::getValue($obj, 'maritalstatus');
        $this->maritalstatusname = ArrayHelper::getValue($obj, 'maritalstatusname');
        $this->medicationhistoryconsentverified = ArrayHelper::getValue($obj, 'medicationhistoryconsentverified');
        $this->middlename = ArrayHelper::getValue($obj, 'middlename');
        $this->mobilecarrierid = ArrayHelper::getValue($obj, 'mobilecarrierid');
        $this->mobilephone = ArrayHelper::getValue($obj, 'mobilephone');
        $this->nextkinname = ArrayHelper::getValue($obj, 'nextkinname');
        $this->nextkinphone = ArrayHelper::getValue($obj, 'nextkinphone');
        $this->nextkinrelationship = ArrayHelper::getValue($obj, 'nextkinrelationship');
        $this->notes = ArrayHelper::getValue($obj, 'notes');
        $this->occupationcode = ArrayHelper::getValue($obj, 'occupationcode');
        $this->onlinestatementonlyyn = ArrayHelper::getValue($obj, 'onlinestatementonlyyn');
        $this->patientid = ArrayHelper::getValue($obj, 'patientid');
        $this->patientphotourl = ArrayHelper::getValue($obj, 'patientphotourl');
        $this->patientphotoyn = ArrayHelper::getValue($obj, 'patientphotoyn');
        $this->portalaccessgiven = ArrayHelper::getValue($obj, 'portalaccessgiven');
        $this->portalsignatureonfile = ArrayHelper::getValue($obj, 'portalsignatureonfile');
        $this->portalstatus = ArrayHelper::getValue($obj, 'portalstatus');
        $this->portaltermsonfile = ArrayHelper::getValue($obj, 'portaltermsonfile');
        $this->povertylevelcalculated = ArrayHelper::getValue($obj, 'povertylevelcalculated');
        $this->povertylevelfamilysize = ArrayHelper::getValue($obj, 'povertylevelfamilysize');
        $this->povertylevelfamilysizedeclined = ArrayHelper::getValue($obj, 'povertylevelfamilysizedeclined');
        $this->povertylevelincomedeclined = ArrayHelper::getValue($obj, 'povertylevelincomedeclined');
        $this->povertylevelincomepayperiod = ArrayHelper::getValue($obj, 'povertylevelincomepayperiod');
        $this->povertylevelincomeperpayperiod = ArrayHelper::getValue($obj, 'povertylevelincomeperpayperiod');
        $this->povertylevelincomerangedeclined = ArrayHelper::getValue($obj, 'povertylevelincomerangedeclined');
        $this->preferredname = ArrayHelper::getValue($obj, 'preferredname');
        $this->primarydepartmentid = ArrayHelper::getValue($obj, 'primarydepartmentid');
        $this->primaryproviderid = ArrayHelper::getValue($obj, 'primaryproviderid');
        $this->privacyinformationverified = ArrayHelper::getValue($obj, 'privacyinformationverified');
        $this->publichousing = ArrayHelper::getValue($obj, 'publichousing');
        $this->race = ArrayHelper::getValue($obj, 'race');
        $this->racename = ArrayHelper::getValue($obj, 'racename');
        $this->referralsourceid = ArrayHelper::getValue($obj, 'referralsourceid');
        $this->registrationdate = ArrayHelper::getValue($obj, 'registrationdate');
        $this->schoolbasedhealthcenter = ArrayHelper::getValue($obj, 'schoolbasedhealthcenter');
        $this->sex = ArrayHelper::getValue($obj, 'sex');
        $this->ssn = ArrayHelper::getValue($obj, 'ssn');
        $this->state = ArrayHelper::getValue($obj, 'state');
        $this->status = ArrayHelper::getValue($obj, 'status');
        $this->suffix = ArrayHelper::getValue($obj, 'suffix');
        $this->veteran = ArrayHelper::getValue($obj, 'veteran');
        $this->workphone = ArrayHelper::getValue($obj, 'workphone');
