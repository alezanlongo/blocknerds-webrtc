 ...
 */
class inline_response_200_7_body extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%inline_response_200_7_bodies}}';
    }
    ...
    {
        return $this->hasMany(dropshipment_create_order_object::class, ['inline_response_200_7_body_id' => 'id']);
    }
    ...
    public function save($runValidation = true, $attributeNames = null) {
        ...
        if( !empty($this->_ordersAr) and is_array($this->_ordersAr) ) {
            foreach($this->_ordersAr as $ordersApi) {
                ...
                $dropshipment_create_order_object->link('inlineResponse2007Body', $this);
