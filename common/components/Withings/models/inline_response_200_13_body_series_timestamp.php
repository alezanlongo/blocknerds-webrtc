 ...
 */
class inline_response_200_13_body_series_timestamp extends \yii\db\ActiveRecord
{

    public static function tableName()
    {
        return '{{%inline_response_200_13_body_series_timestamps}}';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['model_id', 'steps', 'stroke', 'pool_lap', 'duration', 'heart_rate', 'externalId', 'id'], 'integer'],
