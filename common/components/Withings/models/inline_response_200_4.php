 ...
 * @property inline_response_200_4_body $body Response data.
 * @property integer $externalId API Primary Key
 * @property integer $id Primary Key
 */
class inline_response_200_4 extends \yii\db\ActiveRecord
{

    public static function tableName()
    {
        return '{{%inline_response_200_4s}}';
    }
    ...
    {
        return $this->hasOne(inline_response_200_4_body::class, ['id' => 'body_id']);
    }
