 ...
 * @property inline_response_200_12_body $body Response data.
 * @property integer $externalId API Primary Key
 * @property integer $id Primary Key
 */
class inline_response_200_12 extends \yii\db\ActiveRecord
{

    public static function tableName()
    {
        return '{{%inline_response_200_12s}}';
    }
    ...
    {
        return $this->hasOne(inline_response_200_12_body::class, ['id' => 'body_id']);
    }
